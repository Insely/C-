...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	CAN1_TxHeader0.DLC=8;
	CAN1_TxHeader0.ExtId=0;
	CAN1_TxHeader0.IDE=CAN_ID_STD;
	CAN1_TxHeader0.RTR=CAN_RTR_DATA;
	CAN1_TxHeader0.StdId=0x1FF;
	CAN1_TxHeader0.TransmitGlobalTime=DISABLE;
	
	TxMailBox0 = CAN_TX_MAILBOX0;
	Set_GM6020_Voltage[0]=0x22;
  ...
  {
		HAL_Delay(50);
		HAL_CAN_AddTxMessage(&hcan1,&CAN1_TxHeader0,Set_GM6020_Voltage,&TxMailBox0);
    /* USER CODE END WHILE */
